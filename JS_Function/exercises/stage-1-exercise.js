...
function getTruckName(truck) {return truck.name;}
...
function isTruckOpen(truck) {return truck.isOpen;}
...
function getDailySalesTarget(truck) {return truck.DailySalesTarget;}
...
function describeTruck(truck) {return '${truck.name} is located in ${truck.location}.';}
